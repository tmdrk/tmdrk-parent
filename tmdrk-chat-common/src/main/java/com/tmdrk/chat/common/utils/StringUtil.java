...
public class StringUtil {
     ...
     *
     * @param param 包含需要替换的字符串.
     * @param msg0  第一个需要替换的字符串.
     * @param msg1  第二个需要替换的字符串.
     */
     ...
     * @Edit_Description:
     * @Create_Version:51shebao-common-util 1.0
     */
...
//
//        try {
//            tempStr = PinyinHelper.convertToPinyinString(src, " ", PinyinFormat.WITHOUT_TONE);
