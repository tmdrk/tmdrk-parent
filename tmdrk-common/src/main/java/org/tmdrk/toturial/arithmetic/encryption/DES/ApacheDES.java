package org.tmdrk.toturial.arithmetic.encryption.DES;

import com.sun.jersey.core.util.Base64;
import org.bouncycastle.jce.provider.BouncyCastleProvider;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.tmdrk.toturial.arithmetic.encryption.AES.ApacheAES;
 ...
 * @Version 1.0
 **/
public class ApacheDES {
    private static Logger logger = LoggerFactory.getLogger(ApacheDES.class);
    static{
    ...
    public static void main(String[] args) throws Exception {
        String text = "we are family,we should fight";
        byte[] bytes = initKey();
        byte[] ciphertext = encrypt(text.getBytes(), bytes);
        String plaintext = new String(decrypt(ciphertext,bytes));
