package org.tmdrk.toturial.javassist;
...
//        Hello.sayHello();
    ...
    public static void createClass() throws Exception {
        ...
        //定义类
        CtClass stuClass = pool.makeClass("org.tmdrk.toturial.javassist.Student");
        //加载类
//      CtClass cc =  pool.get(classname);
    ...
    public static void extendClass() throws Exception {
        ...
        //设置父类
        stuClass.setSuperclass(pool.get("org.tmdrk.toturial.javassist.Hello"));
...
//        hello.sayGoodbye();
        ...
        // 获取类
        CtClass ctClass = pool.get("org.tmdrk.toturial.javassist.Hello");
...
//        ctClass.writeFile("F:\\javassist");
    ...
    public static void doHotSwapper(){
        ...
        ClassPool pool = ClassPool.getDefault();
        try {
            CtClass clazz = pool.get("org.tmdrk.toturial.javassist.Standard");
            ...
            swap.reload("org.tmdrk.toturial.javassist.Standard", clazz.toBytecode());
            standard.doSomething();
