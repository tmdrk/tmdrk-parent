...
//            System.color.print("id="+map.get("id").toString());
//            if(host==null){
//                System.color.println();
//                continue;
//            }
//            System.color.println("  host="+showStr(host.get("stn"))+" guest="+showStr(guest.get("stn")));
//            if(h_ld!=null){
//                System.color.println("  半场 主队="+showStr(h_ld.get("hrfsp"))+" 让球="+showStr(h_ld.get("hrf"))+" 客队="+showStr(h_ld.get("grfsp"))+" 高于="+showStr(h_ld.get("hdxsp"))+" 大小球="+showStr(h_ld.get("hdx"))+" 低于="+showStr(h_ld.get("gdxsp")));
//            }
//            System.color.println("  全场 主队="+showStr(f_ld.get("hrfsp"))+" 让球="+showStr(f_ld.get("hrf"))+" 客队="+showStr(f_ld.get("grfsp"))+" 高于="+showStr(f_ld.get("hdxsp"))+" 大小球="+showStr(f_ld.get("hdx"))+" 低于="+showStr(f_ld.get("gdxsp")));
//        }
//    }
//
...
//        try {
//            System.color.println("请求开始...");
//            response = httpClient.execute(httpGet);
//            System.color.println("请求结束...");
//            System.color.println("响应状态为:" + response.getStatusLine());
//            HttpEntity responseEntity = response.getEntity();
//            System.color.println("响应内容长度为:" + responseEntity.getContentLength());
