...
public class SendEamilUtil {
    ...
    private static final String FROM = "1308398245@qq.com"; // 发件人邮箱地址
...
//        props.setProperty("mail.smtp.auth", "true");
//        props.setProperty("mail.user", "1308398245@qq.com");
//        props.setProperty("mail.password", "tmdrk19881126");
        ...
        // 简单发送邮件的方式
        Transport.send(message, FROM, "hrsuwfjukqkfhdah"); // 授权码
    }

    public static void main(String[] args) throws AddressException, MessagingException {
        new SendEamilUtil().sentSimpleMail("抢票汇报", "邮件内容", "1308398245@qq.com");
    }
}
