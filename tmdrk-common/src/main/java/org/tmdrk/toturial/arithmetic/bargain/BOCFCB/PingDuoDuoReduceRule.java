 ...
 * 仿拼多多砍价规则。
 */
public class PingDuoDuoReduceRule implements BargainRule {

    private final int percentOfFirstNReduce;
    private final int firstNReduce;

    private final SfBargainRule sfReduceRule = new SfBargainRule();
    ...
    public static void main(String[] args) {
        PingDuoDuoReduceRule rule = new PingDuoDuoReduceRule(50, 5);
        List<Integer> list = rule.getReduceList(new BigDecimal("100.21"), 10);
        int total = 0;
        int i = 0;
